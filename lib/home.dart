...
class _HomePageVupy extends State<HomePageVupy>{
	...
	Future<String> postPub() async {
		...
		if (image != "" || publ.text != ""){
			...
			if(image != ""){
				...
				var multipartFile = new http.MultipartFile('img', stream, length,filename: basename(file.path));
	...
	void initState() {
		...
		void startChatPub() async {
			...
			emojis = json.decode(await rootBundle.loadString('assets/json/finish.json'));
			setState(() {});
		}
																		...
																		children: [
																			Container(
																				...
																				child: ButtonTheme(
																					...
																					child: RaisedButton(
																						...
																						child: Icon(IconData(0xe92b,fontFamily:"icomoon"),size:20.0,color:Colors.white),
																						color: vupycolor,
																					)
																				),
																			),
																			ButtonTheme(
																				...
																				child: RaisedButton(
																					...
																					child: Icon(IconData(0xe9dc,fontFamily:"icomoon"),size:20.0,color:Colors.white),
																			...
																			Expanded(
																				...
																				child: Row(
																					children: [
																						...
																						Text(talks[index][5],style: new TextStyle(fontSize: 16.0, fontWeight: FontWeight.w400,)),
																					],
																				),
																			),
																			talks[index][1] == myId ?
																		...
																		children: [
																			...
																			talks[index][7] == 0 ?
																				GestureDetector(
																					onTap: () async {
																						talks[index][7] = 1;
																						likeMe(index, talks[index][0]);
																					},

																					child: Icon(IconData(0xe97c,fontFamily:'icomoon'), size: 20)
																				)
																			:
																				GestureDetector(
																					onTap: () async {
																					...
																					child: new IconTheme(
																						data: new IconThemeData(color: vupycolor),
																							child: Icon(IconData(0xe900,fontFamily:'icomoon'), size: 20),
																					),

																				),
																			Icon(IconData(0xe998,fontFamily:'icomoon'), size: 20),
																			Icon(IconData(0xe9ce,fontFamily:'icomoon'), size: 20),
																		]
																	),
																),
															],
