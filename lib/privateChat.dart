...
class _PrivateChatVupy extends State<PrivateChatVupy>{
  ...
  void getP() async {
    ...
    jsona["user"] = myId;
		jsona["api"] = api;
		jsona["id"] = id;
		var r = await http.post(Uri.encodeFull(url+"/workserver/getPrivateTalks/"),body:json.encode(jsona));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        leading: IconButton(
					icon: Icon(IconData(0xe912,fontFamily:'icomoon'),color: Colors.black),
					onPressed: () async {
                              ...
                              return Container(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      talks[index][3] != ""
                                          ? Image.network(url + talks[index][3],width: MediaQuery.of(context).size.width * 0.8,)
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(talks[index][5], style: TextStyle(
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(talks[index][4], style: TextStyle(
                                            fontSize: 17,
                      ...
                      child: ButtonTheme(
                        ...
                        child: RaisedButton(
                          ...
                          child: 
                            Align(
                              alignment: Alignment.center,
                              child: Icon(IconData(0xe9cb, fontFamily: "icomoon"), size: 20.0, color: Colors.white),
                            ),
